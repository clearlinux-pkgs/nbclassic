...
Source0  : https://files.pythonhosted.org/packages/67/14/da7665a5f0c3d1c6831d867cc64d20aaedeb50719743594297a844851132/nbclassic-0.3.0.tar.gz
...
%prep
%setup -q -n nbclassic-0.3.0
cd %{_builddir}/nbclassic-0.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621558312
...
cp %{_builddir}/nbclassic-0.3.0/LICENSE %{buildroot}/usr/share/package-licenses/nbclassic/02f19bd915e1c4665a4bbadfceeb74baa4d45bd2
