...
Source0  : https://files.pythonhosted.org/packages/d3/68/5640769e334de9565e954e24bfecce84dbe797aacda8b012806640562855/nbclassic-0.2.7.tar.gz
...
%prep
%setup -q -n nbclassic-0.2.7
cd %{_builddir}/nbclassic-0.2.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617894603
...
cp %{_builddir}/nbclassic-0.2.7/LICENSE %{buildroot}/usr/share/package-licenses/nbclassic/02f19bd915e1c4665a4bbadfceeb74baa4d45bd2
