...
Source0  : https://files.pythonhosted.org/packages/f5/a5/0af0271fd66195bfbdaa03b873b8d14e9050a5c5921afe8c35d80dd61417/nbclassic-0.2.6.tar.gz
...
%prep
%setup -q -n nbclassic-0.2.6
cd %{_builddir}/nbclassic-0.2.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610155775
...
cp %{_builddir}/nbclassic-0.2.6/LICENSE %{buildroot}/usr/share/package-licenses/nbclassic/02f19bd915e1c4665a4bbadfceeb74baa4d45bd2
