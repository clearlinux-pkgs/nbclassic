...
Source0  : https://files.pythonhosted.org/packages/c2/cd/b998e74e2a9ddfb83ad8bbcbdef9f320b5d8907e84f3f4f793d0a985b696/nbclassic-0.2.8.tar.gz
...
%prep
%setup -q -n nbclassic-0.2.8
cd %{_builddir}/nbclassic-0.2.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620745370
...
cp %{_builddir}/nbclassic-0.2.8/LICENSE %{buildroot}/usr/share/package-licenses/nbclassic/02f19bd915e1c4665a4bbadfceeb74baa4d45bd2
