...
Source0  : https://files.pythonhosted.org/packages/04/1f/0bee7bae33531275a2fc193bfe24cc4602c97d9b8e49007bcf6c057a4c0f/nbclassic-0.3.1.tar.gz
...
%prep
%setup -q -n nbclassic-0.3.1
cd %{_builddir}/nbclassic-0.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621618709
...
cp %{_builddir}/nbclassic-0.3.1/LICENSE %{buildroot}/usr/share/package-licenses/nbclassic/02f19bd915e1c4665a4bbadfceeb74baa4d45bd2
