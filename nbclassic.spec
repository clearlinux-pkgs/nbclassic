...
%prep
%setup -q -n nbclassic-0.2.5
cd %{_builddir}/nbclassic-0.2.5
...
cp %{_builddir}/nbclassic-0.2.5/LICENSE %{buildroot}/usr/share/package-licenses/nbclassic/02f19bd915e1c4665a4bbadfceeb74baa4d45bd2
