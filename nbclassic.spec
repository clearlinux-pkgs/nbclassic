...
%prep
%setup -q -n nbclassic-0.3.2
cd %{_builddir}/nbclassic-0.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632413096
...
cp %{_builddir}/nbclassic-0.3.2/LICENSE %{buildroot}/usr/share/package-licenses/nbclassic/02f19bd915e1c4665a4bbadfceeb74baa4d45bd2
